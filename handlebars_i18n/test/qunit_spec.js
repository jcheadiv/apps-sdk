...
test("helper with complex lookup and nested template", function() {
  ...
  shouldCompileTo(string, [hash, fallback], "<a href='/root/goodbye'>"+gt.gettext("Goodbye")+"</a>")
});
...
test("block helper", function() {
  ...
  equal(result, gt.gettext("GOODBYE! cruel world!"));
});
...
test("block helper staying in the same context", function() {
  ...
  equal(result, "<form><p>"+gt.gettext('Yehuda')+"</p></form>");
});
...
test("block helper should have context in this", function() {
  ...
  shouldCompileTo(source, [data, {link: link}], "<ul><li><a href=\"/people/1\">"+gt.gettext('Alan')+"</a></li><li><a href=\"/people/2\">"+gt.gettext('Yehuda')+"</a></li></ul>");
});
...
test("block helper passing a complex path context", function() {
  ...
  equal(result, "<form><p>"+gt.gettext('Harold')+"</p></form>");
});
...
test("nested block helpers", function() {
  ...
  equal(result, "<form><p>"+gt.gettext('Yehuda')+"</p><a href='Yehuda'>"+gt.gettext("Hello")+"</a></form>");
});
...
test("block helper inverted sections", function() {
  ...
  shouldCompileTo(string, hash, "<ul><li>"+gt.gettext('Alan')+"</li><li>"+gt.gettext('Yehuda')+"</li></ul>", "an inverse wrapper is passed in as a new context");
  shouldCompileTo(string, empty, "<p><em>"+gt.gettext("Nobody's here")+"</em></p>", "an inverse wrapper can be optionally called");
  shouldCompileTo(messageString, rootMessage, "<p>"+gt.gettext("Nobody's here")+"</p>", "the context of an inverse is the parent of the block");
});
...
test("partial in a partial", function() {
  ...
  var hash = {dudes: [{name: "Yehuda", url: "http://yehuda"}, {name: "Alan", url: "http://alan"}]};
  shouldCompileTo(string, [hash, {}, {dude: dude, url: url}], gt.gettext('Dudes:')+" "+gt.gettext('Yehuda')+" <a href='http://yehuda'>http://yehuda</a> "+gt.gettext('Alan')+" <a href='http://alan'>http://alan</a> ", "Partials are rendered inside of other partials");
});
...
test("helpers take precedence over same-named context properties", function() {
  ...
  var helpers = {
    goodbye: function() {
      return gt.gettext(this.goodbye.toUpperCase());
    }
  };
  ...
  equals(result, gt.gettext("GOODBYE cruel WORLD"));
});
...
test("helpers take precedence over same-named context properties", function() {
  ...
  var helpers = {
    goodbye: function(fn) {
      return gt.gettext(this.goodbye.toUpperCase()) + fn(this);
    }
  };
