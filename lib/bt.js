...
_.extend(bt, {
  ...
  properties: {
    ...
    get: function(k) { return btapp.properties.get(k) },
  ...
  fb_login: function(appid, scope, callback) {
    ...
    if (callback) {
      btapp.fb_login(appid, scope, cb);
    } else {
      btapp.fb_login(appid, cb);
    }
  },
  fb_apprequest: function(appid, message, to, callback) {
    ...
    //optional params aren't as nice in the C++ code, must do it this way
    if (callback) {
      btapp.fb_apprequest(appid, message, to, cb);
    } else {
      btapp.fb_apprequest(appid, message, cb);
    }
  },
...
(function() {
  ...
  jQuery(document).ready(function() {
    ...
    // don't clobber window.client variable (client -> nativeclient)
