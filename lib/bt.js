...
if (document.domain.indexOf("utorrent.com") != -1) {
  window.utorrent = true;
}
...
(function() {
  ...
  $(document).ready(function() {
    ...
    if (!window.btapp) {
      window.develop = window.utorrent ? false : true;
      window.btapp = stub;
    }
    ...
    // Take html/main.html and set the entire content to the body.
