...
(function($) {
  ...
  window.btrpc = {
    funcs: {
      ...
      _root: [ "peer_id", "sendmsg", "sendtopeer", "language",
               "ready_for_events", "clear_incoming_messages",
               "clear_private_data", "dht", "uninstall",
               "showpreferences", "browseforfolder"],
      events: [ 'keys' ]
    },
  ...
  _.each(btrpc.funcs._root, function(k) {
    btrpc[k] = _.bind(btrpc._transport, this, sprintf('btapp.%s', k));
  });
